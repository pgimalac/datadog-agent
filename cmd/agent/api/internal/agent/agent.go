...
func SetupHandlers(
	...
	r.HandleFunc("/secrets", func(w http.ResponseWriter, r *http.Request) { secretInfo(w, r, secretsComp) }).Methods("GET")
...
func secretInfo(w http.ResponseWriter, r *http.Request, secretsComp secrets.Component) {
	secretsComp.GetDebugInfo(w)
}
