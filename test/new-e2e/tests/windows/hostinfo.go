...
func GetHostInfo(client client.VM) (*HostInfo, error) {
...
func GetHostname(client client.VM) (string, error) {
	hostname, err := client.ExecuteWithError("[Environment]::MachineName")
	if err != nil {
...
func GetJoinedDomain(client client.VM) (string, error) {
	domain, err := client.ExecuteWithError("(Get-WMIObject Win32_ComputerSystem).Domain")
	if err != nil {
...
func GetOSInfo(client client.VM) (*OSInfo, error) {
...
// NetBIOSName converts a given host or DNS name into a NetBIOS formatted name
//
