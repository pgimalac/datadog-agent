...
var ebpfConntrackerCORECreator func(cfg *config.Config, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) = getCOREConntracker
var ebpfConntrackerRCCreator func(cfg *config.Config, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) = getRCConntracker
var ebpfConntrackerPrebuiltCreator func(cfg *config.Config, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) = getPrebuiltConntracker
...
func getManager(cfg *config.Config, buf io.ReaderAt, opts manager.Options, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) {
...
func getPrebuiltConntracker(cfg *config.Config, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) {
...
func getRCConntracker(cfg *config.Config, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) {
...
func getCOREConntracker(cfg *config.Config, bpfTelemetry *nettelemetry.EBPFTelemetry) (*manager.Manager, error) {
	var m *manager.Manager
	var err error
